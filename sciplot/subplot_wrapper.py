...
class SubPlot(object):
    ...
    def append_cbar(self, cmap, norm=None, cbarloc='left', cbarpad=0.05, divider=None, cbar_title=None,
                    cbar_title_size=6, cbar_title_weight='normal', cbartick=3, *args, **kwargs):
        if divider is None:
        ...
        #import pdb; pdb.set_trace()
        self.cb = mpl.colorbar.ColorbarBase(cax, cmap=cmap, norm=norm, orientation=orientation, ticks=np.linspace(norm.vmin, norm.vmax, cbartick).tolist(), *args, **kwargs)
    ...
    def network_axis(self, clist, bounds, labels=None, divider=None, vbar='left', hbar='top', *args, **kwargs):
        ...
        cax_left = divider.append_axes(vbar, size="2%", pad=0)
        ...
        cax_bottom = divider.append_axes(hbar, size="2%", pad=0)
